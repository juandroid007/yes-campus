...
<div class="flex flex-col w-full py-12 text-white">
  ...
  <div class="flex flex-wrap my-12 lg:my-24 lg:w-9/10 lg:mx-auto">
    <div class="flex flex-col ml-auto w-9/10 lg:w-1/2 lg:ml-0 lg:pr-16 lg:mt-52">
    ...
    <div class="flex flex-col mt-12 lg:mr-0 lg:ml-auto w-9/10 lg:w-1/2 lg:ml-0 lg:pl-16 lg:mt-0">
